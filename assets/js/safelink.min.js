...
function auto_safeconvert() {
    ...
    for (var i = 0; i < a_to_va; i++) {
        ...
        if (a_to_vh == false) {
            var encryptedUrl = Aes.Ctr.encrypt(a_to_vi, sconfig["encrypt_key"], 256);;
            a_to_ve[i].href = sconfig["safepage_url"] + encryptedUrl;
